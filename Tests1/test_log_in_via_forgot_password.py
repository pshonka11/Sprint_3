...
# Найти кнопку "Забыли пароль" и нажать её
    WebDriverWait(get_driver, 10).until(EC.element_to_be_clickable(PagesLocators.FORGOT_PASS)).click()

# Найти кнопку "Войти в аккаунт" и нажать её
    WebDriverWait(get_driver, 10).until(EC.element_to_be_clickable(PagesLocators.ENTER_ONE)).click()
